            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                @forelse ($car_list as $car)
                    <div class="card w-96 bg-base-100 shadow-xl">
                        <figure>
                            @isset($car->image)
                                <img class="object-cover h-40 w-86" src="{{ Storage::url($car->image) }}" width="300"
                                    height="300">
                            @endisset
                        </figure>
                        <div class="card-body">
                            ...
                            {{-- <p>{{ $car->description }}</p> --}}
                            <div data-v-51eda008="" class="flex flex-wrap -mx-2">
                                @if ($car->description != null)
                                    ...
                                    @forelse ($descriptions as $desc => $d)
                                        @if ($d == 'Auto')
                                            <div data-v-51eda008=""
                                                class="flex flex-col items-start justify-between px-2 w-1/4">
                                                <div data-v-51eda008="" class="feature-img block rounded"><svg
                                                        data-v-51eda008="" xmlns="http://www.w3.org/2000/svg"
                                                        width="42.258" height="41.036" viewBox="0 0 42.258 41.036">
                                                        <g data-v-51eda008="" id="Group_589" data-name="Group 589"
                                                            ...
                                                            <path data-v-51eda008="" id="Path_294" data-name="Path 294"
                                                                ...
                                                                stroke="#0092ff" stroke-width="1" fill-rule="evenodd">
                                                            </path>
                                                            ...
                                                            <path data-v-51eda008="" id="Path_297" data-name="Path 297"
                                                                ...
                                                                fill-rule="evenodd"></path>
                                                            <path data-v-51eda008="" id="Path_298"
                                                                data-name="Path 298"
                                                                d="M326.953,698.045h-4.546V680.853a2.273,2.273,0,1,1,4.546,0Z"
                                                                transform="translate(801.13 -163.485)" fill="none"
                                                                stroke="#0092ff" stroke-width="1"
                                                                fill-rule="evenodd">
                                                            </path>
                                                            <path data-v-51eda008="" id="Path_299"
                                                                data-name="Path 299"
                                                            ...
                                                            <path data-v-51eda008="" id="Path_300"
                                                                data-name="Path 300" d="M338.4,693.072v3.257"
                                                                transform="translate(803.372 -161.454)" fill="none"
                                                                stroke="#0092ff" stroke-linecap="round"
                                                                stroke-linejoin="round" stroke-width="1"></path>
                                                            <path data-v-51eda008="" id="Path_301"
                                                                data-name="Path 301"
                                                                d="M318.086,672.906a4.914,4.914,0,0,1,3.1-2.784Z"
                                                                transform="translate(800.524 -164.671)" fill="#fff"
                                                                fill-rule="evenodd"></path>
                                                            <path data-v-51eda008="" id="Path_302"
                                                                data-name="Path 302"
                                                                d="M318.086,672.906a4.914,4.914,0,0,1,3.1-2.784"
                                                                transform="translate(800.524 -164.671)" fill="none"
                                                                stroke="#28323c" stroke-linecap="round"
                                                                stroke-linejoin="round" stroke-width="1"></path>
                                                            <path data-v-51eda008="" id="Path_303"
                                                                data-name="Path 303"
                                                                d="M318.086,672.906a4.914,4.914,0,0,1,3.1-2.784Z"
                                                                transform="translate(800.524 -164.671)" fill="#fff"
                                                                fill-rule="evenodd"></path>
                                                            <path data-v-51eda008="" id="Path_304"
                                                                data-name="Path 304"
                                                                d="M318.086,672.906a4.914,4.914,0,0,1,3.1-2.784"
                                                                transform="translate(800.524 -164.671)" fill="none"
                                                                stroke="#0092ff" stroke-linecap="round"
                                                ...
                                                <div data-v-51eda008="" class="feature-text text-xs font-light"
                                                    style="color: rgb(70, 79, 99);">
                                                    Automatic
                                                </div>
                                            </div>
                                        @elseif ($d == 'Manual')
                                            ...
                                            <div data-v-51eda008=""
                                                ...
                                                <div data-v-51eda008="" class="feature-img block rounded"><svg
                                                        ...
                                                        <g data-v-51eda008="" id="Group_588" data-name="Group 588"
                                                            ...
                                                            <path data-v-51eda008="" id="Path_286"
                                                                data-name="Path 286"
                                                            ...
                                                            <path data-v-51eda008="" id="Path_287"
                                                                data-name="Path 287"
                                                                ...
                                                                stroke="#0092ff" stroke-width="1.027"
                                                                fill-rule="evenodd"></path>
                                                            <path data-v-51eda008="" id="Path_288"
                                                                data-name="Path 288"
                                                                d="M221.173,688.917s1.129-3.8,4.207-5.236Z"
                                                                transform="translate(788.876 -162.77)" fill="#fff"
                                                                fill-rule="evenodd"></path>
                                                            <path data-v-51eda008="" id="Path_289"
                                                                data-name="Path 289"
                                                                d="M221.173,688.917s1.129-3.8,4.207-5.236"
                                                                transform="translate(788.876 -162.77)" fill="none"
                                                                stroke="#0092ff" stroke-linecap="round"
                                                                stroke-linejoin="round" stroke-width="1"></path>
                                                            <g data-v-51eda008="" id="Group_231"
                                                                data-name="Group 231"
                                                                transform="translate(1037.656 533.238)">
                                                                <path data-v-51eda008="" id="Path_290"
                                                                    data-name="Path 290" d="M245.386,694.493v3.58"
                                                                    transform="translate(-245.386 -694.493)"
                                                                    fill="none" stroke="#0092ff"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="1"></path>
                                                            </g>
                                                        </g>
